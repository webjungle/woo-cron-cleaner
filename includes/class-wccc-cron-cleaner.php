...
class WCCC_Cron_Cleaner_Pro {
    ...
    public function enqueue_admin_styles($hook) {
        if (strpos($hook, 'wccc-settings') !== false || strpos($hook, 'wccc-cron-overview') !== false) {
            wp_enqueue_style(
                'wccc-admin-css',
            ...
            wp_enqueue_script(
                ...
                plugins_url('../assets/css/darkmode-toggle.js', __FILE__),
                [],
                filemtime(plugin_dir_path(__FILE__) . '../assets/css/darkmode-toggle.js'),
                true
            );
        }
    }
